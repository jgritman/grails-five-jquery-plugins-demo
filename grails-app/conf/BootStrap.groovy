...
class BootStrap {
    ...
    def init = { servletContext ->
    	...
    	def hibernateCourse = new Course(name:"Hibernate with Spring",description:"Learn to build ORM-based applications with Spring and the Hibernate ORM API. ",days:3,basePrice:2090,partner:vmware).save()

    	def enterpriseIntegration = new Course(name:"Enterprise Integration with Spring",description:"Deep dive into integration topics including SOAP and RESTful Web Services, messaging with JMS, transaction management, Spring Integration, Spring Batch and more.",days:4,basePrice:2790,partner:vmware).save()
    	...
    	new Class(course:enterpriseIntegration,startDate:Date.parse("dd-MM-yyyy","15-11-2011")).save()
